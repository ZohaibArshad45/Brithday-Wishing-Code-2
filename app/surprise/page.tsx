...
//   const [textRevealed, setTextRevealed] = useState<number[]>([]); // ✅ Type fixed here
...
//         setTextRevealed((prev) => [...prev, cosmicMessages[i].id]); // ✅ Now type safe
...
//   }, []); // ✅ Removed cosmicMessages from dependencies since it's constant
...
//     }
//   }, [stage, cosmicWishes.length]);

//   const ParticleField = ({ type = "stars" }: { type: string }) => {
